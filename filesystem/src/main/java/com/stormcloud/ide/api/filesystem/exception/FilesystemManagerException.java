package com.stormcloud.ide.api.filesystem.exception;
...
public class FilesystemManagerException extends Exception {
     ...
     */
    public FilesystemManagerException(String msg) {
        super(msg);
    }

    public FilesystemManagerException(Throwable thrwbl) {
        super(thrwbl);
    }

    public FilesystemManagerException(String string, Throwable thrwbl) {
        super(string, thrwbl);
    }
}
